...
- `docs/` - ostatni zbudowany output (to co realnie wisiało na GitHub Pages przed migracją)
- `README-original.md`, `LICENSE` - oryginalne pliki repo

Pełna historia dostępna też w git log repo (nic nie ginie), to jest
dodatkowo widoczna, płaska kopia "na wszelki wypadek".
